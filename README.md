...
Веб-застосунок для аналізу сільськогосподарських знімків із використанням комп'ютерного зору (U-Net + EfficientNet).
...
> ⚠️ Перед запуском змініть email і пароль у `create_admin.py`
